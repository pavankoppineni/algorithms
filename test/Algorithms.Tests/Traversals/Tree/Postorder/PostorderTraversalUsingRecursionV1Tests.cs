...
{
    [TestClass]
    public class PostorderTraversalUsingRecursionV1Tests
    {
        [TestMethod]
        public void Given_Tree_When_PostorderTraversal_Then_ShouldReturnItemsInPostOrder()
        {
            //Given
            ...
            var problem = new PostorderTraversalUsingRecursionV1();
