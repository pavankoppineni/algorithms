...
{
    [TestClass]
    public class PreorderTraversalUsingStackV1Tests
    {
        [TestMethod]
        public void Given_Tree_When_PreorderTraversal_Then_ShouldReturnNodesInPreorderFashion()
        {
            //Given
            ...
            var problem = new PreorderTraversalUsingStackV1();
            var expectedResult = new List<int> { 1, 2, 4, 5, 3 };
